"""
Django settings for tesmt_44401 project.
...
WSGI_APPLICATION = 'tesmt_44401.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tesmt_44401 API",
    "DESCRIPTION": "API documentation for tesmt_44401 App",
    "VERSION": "v1",
}
